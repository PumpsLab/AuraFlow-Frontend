...
const testimonials = [
    {
        ...
        text: "We switched our entire 40-person team to AuraFlow last month. Employees love seeing their earnings tick up every second. Zero complaints since day one.",
    ...
    },
    {
        name: "Marcus Webb",
        handle: "@marcus_web3",
        text: "As a DAO treasurer, I needed private payroll. AuraFlow's zero-knowledge streams mean our contributor salaries never hit the public chain. Game changer.",
    ...
    },
    {
        ...
        text: "We integrated the AuraFlow API directly into our HRIS. Payroll runs itself now. Our finance team actually thanked the engineering team for once.",
