            ...
            <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-start">
                ...
                >
                    ...
                    <p className="text-gray-400 text-lg leading-relaxed mb-10">
                        AuraFlow provides real financial privacy without compromising on the features modern teams need from payroll infrastructure.
                    </p>
                ...
                >
                    ...
                    >
                        ...
                        <p className="text-gray-400 text-sm leading-relaxed">
                            Every operation in AuraFlow is private by default. No configuration needed. No opt-in required. Privacy is the foundation, not a feature.
                        </p>
                    </motion.div>
                </motion.div>
            </div>
