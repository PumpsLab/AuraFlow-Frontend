          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-lg text-gray-500 mb-8">
                AuraFlow provides real financial privacy without compromising on
            ...
            <div className="bg-gray-50 rounded-3xl p-8 border border-gray-100 shadow-inner">
              ...
              <div className="mt-8 p-8 bg-black rounded-3xl shadow-xl">
                ...
                <p className="text-gray-400 text-sm leading-relaxed">
                  Every operation in AuraFlow is private by default. No
      ...
      <footer className="bg-transparent py-16 px-4 sm:px-6 lg:px-8 border-t border-gray-200">
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-4 gap-12 mb-12">
            <div className="md:col-span-2">
              <div className="flex items-center gap-2 mb-8">
                <img src="/logo.png" alt="AuraFlow" className="h-20 w-auto" />
              </div>
              <p className="text-gray-500 mb-6 max-w-sm">
                Privacy-first payroll infrastructure on Stellar. Real-time
            ...
            <div>
              ...
              <ul className="space-y-3 list-none p-0 m-0">
                <li className="text-gray-500 text-sm">Stellar Testnet</li>
                <li className="text-gray-500 text-sm">Soroban Contracts</li>
                <li className="text-gray-500 text-sm">Freighter Wallet</li>
                <li className="text-gray-500 text-sm">SAC Encryption</li>
              </ul>
            </div>
          </div>
          ...
          <div className="border-t border-gray-200 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-sm text-gray-400">
              © {new Date().getFullYear()} AuraFlow. Open source under MIT
              license.
            </p>
            <p className="text-sm text-gray-400">
              Private payroll, per-second streaming, on Stellar 🔒
            </p>
          </div>
        </div>
      </footer>
