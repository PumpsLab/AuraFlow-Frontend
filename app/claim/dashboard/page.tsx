          ...
          <div>
            ...
            <p className="mt-2 max-w-lg text-sm leading-relaxed text-[#a8a8aa]">
              {hasPrivatePayrollMode
                ? "AuraFlow handles your private payroll balance and private payouts. Withdraw whenever your employer sends salary privately."
                : "Stellar handles funding and exits. AuraFlow handles your live private salary accrual and claimable state."}
            </p>
          </div>
            ...
            <div className="mt-12 rounded-[2rem] border border-dashed border-white/20 bg-white/[0.02] p-12 text-center">
              ...
              <p className="mx-auto mt-2 max-w-md text-sm leading-relaxed text-[#8f8f95]">
                {hasPrivatePayrollMode
                  ...
                  : "Connect a wallet registered with AuraFlow to see your live payroll dashboard."}
              </p>
            </div>
          )}
