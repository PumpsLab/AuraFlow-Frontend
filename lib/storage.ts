...
const getKeys = (wallet: string) => ({
  PAYROLL_HISTORY: `auraflow_${wallet}_payroll`,
  CLAIM_HISTORY: `auraflow_${wallet}_claims`,
  SETUP_HISTORY: `auraflow_${wallet}_setup`,
  WALLET_ROLE: `auraflow_${wallet}_role`,
});
